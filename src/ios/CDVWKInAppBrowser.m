...
- (void)createViews
{
   ...
   if (@available(iOS 11.0, *)) {
    ...
    NSString* backArrowString = NSLocalizedString(@"<img src='https://s3.ap-southeast-2.amazonaws.com/files.classhive.com.au/img/back_icon@2x.png' />", nil); // create arrow from Unicode char
